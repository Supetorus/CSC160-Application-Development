...
namespace Login {
    ...
    public partial class Users : global::System.Data.DataSet {
        ...
        public partial class UserInfoDataTable : global::System.Data.TypedTableBase<UserInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserInfoRow AddUserInfoRow(int ID, string Name, string Password, string Email) {
...
namespace Login.UsersTableAdapters {
    ...
    public partial class UserInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserInfo] WHERE (([ID] = @Original_ID) AND ([Name] = @Original" +
                "_Name) AND ([Password] = @Original_Password) AND ([Email] = @Original_Email))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserInfo] ([ID], [Name], [Password], [Email]) VALUES (@ID, @Na" +
                "me, @Password, @Email);\r\nSELECT ID, Name, Password, Email FROM UserInfo WHERE (I" +
                "D = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserInfo] SET [ID] = @ID, [Name] = @Name, [Password] = @Password, [Email] = @Email WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Password] = @Original_Password) AND ([Email] = @Original_Email));
SELECT ID, Name, Password, Email FROM UserInfo WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=THE-SECOND;Initial Catalog=Users;Integrated Security=True;Connect Tim" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Password, Email FROM dbo.UserInfo";
